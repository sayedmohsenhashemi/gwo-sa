...
public class Helper {
    ...
    public static void printResults(
        ...
        int numberOfNodeShutdowns = timeBeforeHostShutdown.size();
        ...
        if (outputInCsv) {
            ...
            data.append(String.format("%d", numberOfNodes) + delimeter);
            ...
            data.append(String.format("%d", numberOfNodeShutdowns) + delimeter);
            ...
            Log.printLine();
            Log.printLine(String.format("Number of Nodes: " + numberOfNodes));
            Log.printLine(String.format("Energy consumption: %.2f J", energy));
            Log.printLine(String.format("Number of migrations: %d", numberOfMigrations));
            ...
            Log.printLine(String.format("Number of nodes shutdowns: %d", numberOfNodeShutdowns));
            ...
            if (datacenter.getVmAllocationPolicy() instanceof PowerVmAllocationPolicyMigrationAbstract) {
                ...
                */
                ...
                Log.printLine(String.format(
                        "Execution time - Containers reallocation mean: %.5f sec",
                        executionTimeVmReallocationMean));

                Log.printLine(String
                        .format("Execution time - Containers selection: %.5f sec", executionTimeTotalStDev));
