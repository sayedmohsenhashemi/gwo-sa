...
public abstract class DataCenterAbstract extends PowerVmAllocationPolicyAbstract {
    ...
    private final List<Double> degreeOfImbalances = new LinkedList<Double>();

    private final List<Double> responseTime = new LinkedList<Double>();
     ...
     */
    public List<Double> degreeOfImbalance() {
        return degreeOfImbalances;
    }
