...
public class Run_GOA {

    private static int searchAgentsNo = 40;
    private static String functionName = "F1";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            double[] value = goa.getTargetPosition();
            System.out.print(value + " ");
            TimeKeeper.getInstance().setSimulationStartTime(Calendar.getInstance().getTimeInMillis());
            boolean enableOutput = true;
            boolean outputToFile = false;
            String str = "mu";
            String inputFolder = Run_GOA.class.getClassLoader().getResource("workload").getPath();
            String workload = "workload";
            String parameter = "1.2";
            String AllocationPolicy = "GOA";
            String outputFolder = "output";

            Run_GOA newRunners = new Run_GOA();
            Run_GOA.Nodes runner = newRunners.new Nodes(enableOutput, outputToFile, inputFolder, outputFolder, workload, AllocationPolicy, str, parameter);
